# Use factorygirl and Faker gems to generate object factories
# Thenm you could say:
# 1.upto(5) { create(:user) }
# The User factory will use Faker to generate fake data for name/etc
#
...
group1 = Group.create!(name: 'Sea Lions', creator: user1, spending_limit: 25, users: [user1, user2, user3])
group2 = Group.create!(name: 'Jackals', creator: user4, spending_limit: 35, users: [user4, user5, user6])
group3 = Group.create!(name: 'Phase Up', creator: user3, spending_limit: 100, users: [user1, user2, user3, user4, user5, user6])
